...
class App {
  ...
  _newWorkout(e) {
    ...
    let workout;
    // if workout running, create running oblect
    if (type === 'running') {
    ...
    // if workout cycling, create cycling oblect
    if (type === 'cycling') {
    ...
    //add new ob ject to workout array 
  ...
  _renderWorkoutMarker(workout) {
    L.marker(workout.coords).addTo(this.#map)
      .bindPopup(L.popup({
        maxWidth: 250, minWidth: 100, autoClose: false, closeOnClick: false,
